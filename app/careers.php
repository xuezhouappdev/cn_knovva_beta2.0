        ...
        <div class="row justify-content-center">
            <div class="col-sm-9">
                ...
                <table class="table ">
                    ...
                    <tr>
                        <td scope="row"><a target="_blank" class="pull-left" href="position_esl.php">English Native Speake for Online Live Class Teaching
                            </a></td>
...
<div class="loveourpeople">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <img class="img img-responsive" src="img/1.jpg">
            </div>
            <div class="col-md-4">
                <img class="img img-responsive" src="img/3.jpg">
            </div>
            <div class="col-md-4">
                <img class="img img-responsive" src="img/2.jpg">
            </div>
        </div>
