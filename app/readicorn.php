...
<!--                       </div>-->
               ...
               <p>由Knovva Acadmey哈佛团队带领的英语原著阅读课程，中外双师同步线上授课，每期精选经典英文原著详细解读。
                   配合轻松课堂氛围，通过24周的文本阅读循序渐进，学生将逐步拓展词汇量、 储备历史文化知识、提升阅读理解和文 学思辨素养。寓学于乐，从而提升SAT等应试能力、体验英美大学课程及阅读模式。
               </p>

               <h5>教师团队</h5>
               <p>中教Chunxiao毕业于哈佛大学教育学 院，曾在北京新东方学校、北外青少英 语和非洲喀麦隆等地积累了丰富的英汉 双语教学经验，熟知中国学生英语学习 的痛点难关。她将带领大家进行精读理 解，并结合SAT核心词汇助学员灵学活 用，巩固课堂所知。</p>
               <p>外教Becca同样毕业于哈佛大学教育学 院，她来自美国东北部，具备7年互动 教学经验。由她带领美国资深教师团队 深度解读英美文化、引导思辨讨论。使 得汉语到英语的鸿沟不再难以跨越，东 方至西方的文化过渡更为直观与易于理 解。</p>
           </div>
        ...
        <table class="table table-striped table-sm">
            ...
            <tr>
                ...
                <td>
                    <ul class="list-inline">
                        <li>每周阅读</li>
                        <li>课前学习资料包 - 包括词汇表、导读 问题、课堂笔记表</li>
                        <li>微信群答疑 - 群内中教外教同时
                            为学生解答问题</li>
                    </ul>
                </td>
            ...
            <tr>
                ...
                <td>
                    <ul class="list-inline">
                        <li>模拟SAT词汇练习</li>
                        <li>微信群答疑 - 群内中教外教同时 文本细读 为学生解答问题</li>
                    </ul>
                </td>
            </tr>
            </tbody>
