<?php
$pageTitle="职位 - 视觉设计全职/实习生  | Knovva Academy";
$position = "视觉设计全职/实习生 ";
$embed_url ="position_shijuesheji";
...
?>
    ...
    <!--position banner-->
    <div class="position-banner" style="background: url('./img/position-led.jpg') center
    ...
    <div class="job-description">
        <div class="container">
                ...
                <h5>企业介绍</h5>
                <p>Knovva Academy总部位于美国波士顿，是专注开发创新型教学产品的前沿教育科技公司。作为美国顶尖高中的系统化内容提供方，Knovva Academy为全球高中生提供新型校外课程、进行多元化教学补充。（www.knovva.com）
                </p>
                ...
                <ul>
                    <li>线上教学材料、课件等设计美化。</li>
                    <li>网页视觉设计美化。</li>
                    <li>各种尺寸横幅、展板、海报等宣传品设计。</li>
                    <li>线下物料包装制作。</li>
                </ul>

                <h5>任职要求</h5>
                <ul>
                    <li>本科及以上相关专业学历，2年以上网页运营视觉设计和线下物料设计经验。</li>
                    <li>有运营设计的成功案例和作品，具备教育类产品相关经验者优先。</li>
                    <li>有扎实的美术基础，手绘能力强，拥有宽广的行业视野与时尚的审美标准。</li>
                    <li>能清楚表达设计理念，准确定位用户偏好和使用习惯。</li>
                    <li>有团队合作意识、责任心和积极的学习态度，对视觉设计有激情和创新精神。</li>
                </ul>
                ...
                <h5>工作福利</h5>
                <ul>
                    <li>与美东优秀设计学院（罗德岛、波士顿大学、东北大学）优秀校友共事，学习机会丰富。</li>
                    <li>有竞争力的薪酬福利，全职有五险一金。</li>
...
<!--            <p>The <b>Curriculum Designer</b> is a full-time position based in Knovva Academy’s office in the Seaport neighborhood of Boston. Salary is competitive and commensurate with experience. <b>Must be authorized to work in the United States.</b></p>-->
                ...
                <h5>简历投递</h5>
            <p>请将简历投递至<a href="mailto:abby.hu@knovva.com ?Subject=简历投递" target="_top">abby.hu@knovva.com</a>。</p>
