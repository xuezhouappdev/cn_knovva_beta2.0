...
<!--                       </div>-->
               ...
               <p>“跨界”(CROSS+)项目以混合式学习为依托，将在国际视野、 本土行动、少年领导力、跨文化沟通的主题下，融合模块化学习 的线上形式与定制化的线下活动，为全球高中学生提供完整的活动方案。<br><br>
                   学员可通过此项目积累出众的实践经验，以国际化的视野和多元思维夯实基础，获得有效的课外补充。“跨界”项目提供跨学科、 跨国界、跨文化、跨媒介的整体解决方案，为培养未来领袖奠定基石。
               </p>

               <h5>应用形式</h5>
               <p><b>学校课程的创新</b> - “跨界”项目以灵活的线上课程和线下活动为亮点，在可制定化的前提下，以高度兼容性的课程技术平台为依托，并配备完善的教师使用手册与培训教程，是学校创新实验性课程的优选。
                   部分波士顿地区的顶尖中学全套或部分地引进该项目，以线上的“翻转课堂”进行教学，或以线下实践来充实学生课余活动。</p>
               <p><b>课外实践的拓展</b> - 除丰富的选择内容外，“跨界”项目更是为了契合学生的个性发展开设辅导课程，学生可自主地接受课外实践，获得背景提升。</p>

               <h5>研发团队</h5>
               <p>“跨界”(CROSS+)研发团队来自北美、中东、亚洲，团队构成同步诠释了“跨界”理念。团队成员毕业于哈佛大学教育学院、政 府学院、附属戏剧学院等，对全球各地的教育现状与学生所需有深刻的见解，致力于将最前沿、最行之有效的教育方法融入项目设计。此外，“跨界”的合作开发方为美国最老资历的高中全美高中前20强的波士顿拉丁学校，为项目质量提供了有力保障。</p>
           </div>
        ...
        <table class="table table-striped table-sm">
            ...
            <tr>
                ...
                <td>
                   ...
                   <p><b>模块化课程</b><br>线上课程包含国际理解、本土行动、少年领导力、跨文化沟通4个模块，各模块间相互独立、互为补充。各版块为期8周，分别包含六次线上课程、六次跨国小组作业及一次跨国项目。学生根据自身需求选择课程模块进行自主学习，并在活动导师的辅助下加入跨国小组、完成任务。</p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                   ...
                   <p><b>定制化活动</b><br>线下活动在寒暑假举行，综合学生需求、线上课程和跨国项目完成情况而定制，活动周期持续1~4周不等。可选活动包括:波士顿极速创新挑战赛(Innova- thon)、南美国家发展营、剑桥社创企业实习等。</p>
                </td>
            </tr>
...
<div class="course-benefits course-benefits-2col">
    <div class="container">
        ...
        <div class="row wow justify-content-center fadeIn">
           ...
           <div class="col-md-9">
               <p><b>跨学科: </b>超越学科界限，每一堂线上课程将渗透不同学科的知识技能及思维方式。学科课程内容涵盖自然科学、人文科学，多维构建学生的全局观和大视野。线下活动要求学生充分调动跨学科知识，为学生成为综合性人才夯实基础。</p>
           </div>
       </div>
